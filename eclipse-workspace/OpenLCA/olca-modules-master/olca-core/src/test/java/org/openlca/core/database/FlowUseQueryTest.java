...
public class FlowUseQueryTest {
	...
	public void testUsedAsOutput() {
		...
		System.out.println("testUsedAsOutput() - recipientIds:" 
		+ recipientIds);
		System.out.println("testUsedAsOutput() - providerIds:" 
		+ providerIds);
		System.out.println("testUsedAsOutput() - exchange:" 
		+ exchange);
	}
	...
	public void testUsedAsInput() {
		...
		System.out.println("testUsedAsInput() - recipientIds:" 
		+ recipientIds);
		System.out.println("testUsedAsInput() - providerIds:" 
		+ providerIds);
		System.out.println("testUsedAsInput() - exchange:" 
		+ exchange);
	}
}
