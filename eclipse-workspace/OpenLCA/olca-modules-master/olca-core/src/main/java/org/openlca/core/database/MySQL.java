...
//		jpaConfig.put("jakarta.persistence.jdbc.driver", "org.mariadb.jdbc.Driver");
		jpaConfig.put("jakarta.persistence.jdbc.driver", "com.mysql.jdbc.Driver");
	...
	public static Connection getMySQLConnection() 
		...
		// 1. Connect
		String url = "jdbc:mysql://localhost:3306/openlca";
		String user = "root";
		String pw = "6457";
	...
	public static class Config {
		...
		private String url = "jdbc:mysql://hostlocal:3306/openlca";
