                ...
                <div class="container-fluid">
                    ...
                    <main class="main">
                        <form action="calc-insert" method="post" id="survey-form" class="survey" novalidate>
                            ...
                            <div class="process-wrap active-step2" tabindex="0" role="progressbar" aria-valuemin="1" aria-valuemax="7" aria-valuenow="1" aria-valuetext="Question 1 of 5: How long have you been using our product?">
                            ...
                            <div class="mt-2">
                                ...
                                <button class="button" type="button" name="next" aria-label="Next" aria-hidden="true"
                                onclick="location.href='manufacture-process.jsp';">Next</button>
                                <button class="button" type="button" name="prev" aria-label="Previous" aria-hidden="true"
                                onclick="location.href='project-info.jsp';">Prev</button>
                            </div>
                            ...
                            <div class="mt-1">
                                ...
                                <div class="card my-card1 shadow mb-2">
                                    ...
                                    <div class="card-body">
                                        <!--
                                        <h6 class="m-0 font-weight-bold text-primary">공정명</h6>
                                        <input type="text" name="psName" class="form-control form-control-user mt-2" required placeholder="Pellet Process"/>
                                        
                                        <h6 class="m-0 font-weight-bold text-primary mt-4">Input/Output</h6>
                                        -->
                                        <!-- Input Parameter Table -->
                                        <div class="table-responsive col-6" style="display:inline-block;">
                                            <table class="table table-bordered" id="normal" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th class="text-primary" width="40%">Input</th>                                                  
                                                        <th>값</th>
                                                        <th>단위</th>
                                                    </tr>
                                                </thead>
                                        ...
                                        <div class="table-responsive col-5 position-relative my-position-relative" style="display:inline-block; top:-3.95rem;">
                                            <table class="table table-bordered" id="normal" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th class="text-primary" width="40%">Output</th>                                                  
                                                        <th>값</th>
                                                        <th>단위</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>물</td>
                                                        <td><input type="text" name="outputs" class="form-control form-control-user" required placeholder="1.0"></td>
                                                        <td>
                                                            <div class="dropdown">
                                                                <select name="oUnits" id="dropdown" class="form-control">
                                                                    <option value="kg">kg</option>
                                                                    <option value="m">m</option>
                                                                    <option value="m2">m2</option>
                                                                    <option value="kWh">kWh</option>
