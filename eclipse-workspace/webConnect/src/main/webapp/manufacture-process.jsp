                ...
                <div class="container-fluid">
                    ...
                    <main class="main">
                        <form action="calc-insert" method="post" id="survey-form" class="survey" novalidate>
                            ...
                            <div class="process-wrap active-step3" tabindex="0" role="progressbar" aria-valuemin="1" aria-valuemax="6" aria-valuenow="1" aria-valuetext="Question 1 of 5: How long have you been using our product?">
                            ...
                            <div class="mt-2">
                                ...
                                onclick="location.href='distribution-process.jsp';">Next</button>
                                <button class="button" type="button" name="prev" aria-label="Previous" aria-hidden="true"
                                onclick="location.href='data-make-process.jsp';">Prev</button>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                                ...
                                                <h6 class="m-0 font-weight-bold text-primary">부품가공</h6>
                                            </a>
                                            ...
                                            <div class="collapse show" id="collapseCardExample">
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive col-5 position-relative my-position-relative" style="display:inline-block;">
                                                        <table class="table table-bordered" id="normal" width="100%" cellspacing="0">
                                                            <thead>
                                                                <tr>
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                                role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                                <h6 class="m-0 font-weight-bold text-primary">플라스틱가공</h6>
                                            </a>
                                            <!-- Card Content - Collapse -->
                                         ...
                                         <div class="card mb-4">
                                            ...
                                            <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                                role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                                <h6 class="m-0 font-weight-bold text-primary">금속가공</h6>
                                            </a>
                                            <!-- Card Content - Collapse -->
                                            <div class="collapse" id="collapseCardExample">
                                                <div class="card-body">
